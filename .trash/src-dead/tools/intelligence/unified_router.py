...
class UnifiedDelegationRouter:
    ...
    def _init_components(self):
        ...
        if self._memory_router is None:
            try:
                from src.tools.intelligence.memory_routing import get_memory_router
        ...
        if self._trigger_router is None:
            try:
                from src.tools.intelligence.trigger_routing import get_trigger_router
        ...
        if self._local_analyzer is None:
            try:
                from src.tools.intelligence.local_model_analysis import (
                    get_local_analyzer,
                )
        ...
        if self._routing_optimizer is None:
            try:
                from src.tools.intelligence.routing_optimizer import (
        ...
        if self._complexity_scorer is None:
            try:
                from src.tools.intelligence.complexity_scorer import score_complexity

                self._complexity_scorer = score_complexity
            except Exception as e:
        ...
        if self._ml_router is None:
            try:
                from src.tools.intelligence.ml_router import get_ml_router
        ...
        if self._skill_registry is None:
            try:
                from src.tools.intelligence.skill_registry import get_skill_registry
        ...
        if self._health_monitor is None:
            try:
                from src.tools.intelligence.health_monitor import get_health_monitor
        ...
        if self._context_sharing is None:
            try:
                from src.tools.intelligence.context_sharing import get_context_sharing
        ...
        if self._task_decomposer is None:
            try:
                from src.tools.intelligence.task_decomposer import get_task_decomposer
        ...
        if self._prompt_templates is None:
            try:
                from src.tools.intelligence.prompt_templates import (
        ...
        if self._ab_testing is None:
            try:
                from src.tools.intelligence.ab_testing import get_ab_testing
        ...
        if self._agent_communication is None:
            try:
                from src.tools.intelligence.agent_communication import (
        ...
        if self._advanced_learning is None:
            try:
                from src.tools.learning.advanced_learning import AdvancedLearningEngine
                from src.tools.learning.advanced_learning import ActionType
