...
if __name__ == "__main__":
    ...
    print(f"  Consolidate enabled: {config['consolidate_enabled']}")
    print(f"  Forget enabled: {config['forget_enabled']}")
    print(f"  Min confidence: {config['min_confidence']}")
    print(f"  Exploration rate: {config['exploration_rate']}")
    print(f"  Consolidation threshold: {config['consolidation_threshold']}")
    print(f"  Learning cycle: {config['learning_cycle_minutes']} minutes")
    print(f"  Feedback TTL: {config['feedback_ttl_days']} days")
    print(f"  Mandatory retention: {config['mandatory_retention_days']} days")
