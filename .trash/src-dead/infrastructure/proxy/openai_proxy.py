...
PROVIDERS = {
    "opencode": {
        ...
        "models": ["minimax-m2.5-free", "mimo-v2-pro-free", "mimo-v2-omni-free"],
    },
    "openrouter": {
        "base_url": "https://openrouter.ai/api/v1",
        "api_key": os.getenv("OPENROUTER_API_KEY", ""),
        "models": ["deepseek/deepseek-r1:free", "minimax/minimax-m2.5:free"],
    },
    "google": {
...
async def chat_completions(request: dict) -> dict:
    ...
    model = request.get("model", "minimax-m2.5-free")
