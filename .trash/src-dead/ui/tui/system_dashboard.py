...
class SystemDashboard(App):
    ...
    def refresh_system_overview(self) -> None:
        ...
        try:
            ...
            # Check daemon
            try:
                from src.memory.daemon import MemoryDaemon
            ...
            # Check file indexing
            try:
                from src.memory.drive_embedder import get_indexed_count
    ...
    def refresh_intelligence(self) -> None:
        ...
        try:
            ...
            # Tool contracts
            try:
                from src.intelligence.tool_contract import get_tool_registry
            ...
            # Permission engine
            try:
                from src.intelligence.permission_engine import get_permission_engine
    ...
    def refresh_security(self) -> None:
        ...
        try:
            ...
            # Security gate
            try:
                from src.intelligence.security_gate import SecurityGate
            ...
            try:
                from src.intelligence.code_quality_tracker import (
    ...
    def refresh_learning(self) -> None:
        ...
        try:
            ...
            try:
                from src.memory.mcp_server import get_learning_stats
