...
def get_memory_stats():
    ...
    try:
        from src.memory.mcp_server import get_memory_stats as _get_stats
        return _get_stats()
    except Exception:
...
def get_indexed_count():
    ...
    try:
        from src.memory.drive_embedder import get_indexed_count as _get_count
        return _get_count()
    except Exception:
...
def get_learning_stats():
    ...
    try:
        from src.memory.mcp_server import get_learning_stats as _get_stats
        return _get_stats()
    except Exception:
