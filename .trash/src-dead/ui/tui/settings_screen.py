...
def get_learning_config():
    try:
        from src.memory.learning_config import get_config as _gc
...
def save_learning_config(updates: dict) -> bool:
    try:
        from src.memory.learning_config import get_config, save_config
...
def reset_learning_config() -> bool:
    try:
        from src.memory.learning_config import reset_config
...
def get_drive_status():
    try:
        from src.memory.config import health_check_drives, list_drives
