...
def get_session_memory(session_id: str = None, notes_path: str = None) -> SessionMemory:
    """Get or create a SessionMemory instance.

    Args:
        session_id: Session identifier (auto-generated if not provided)
        notes_path: Path to notes file (default: .sisyphus/sessions/{session_id}.json)
    ...
    if notes_path is None:
        notes_path = f".sisyphus/sessions/{session_id}.json"
