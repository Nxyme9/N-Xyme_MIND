...
class MemoryReconsolidation:
    ...
    def detect_conflicts(
        ...
        for mem_id, mem_content, mem_timestamp in existing_memories:
            ...
            similarity = len(new_words & mem_words) / max(len(new_words), len(mem_words))
    ...
    def _classify_conflict(self, new_content: str, old_content: str) -> str:
        ...
        contradiction_patterns = ["not", "no longer", "changed", "wrong", "incorrect", "instead"]
...
# Global singleton
_reconsolidator = MemoryReconsolidation()
