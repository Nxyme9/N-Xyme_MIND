...
# ---------------------------------------------------------------------------
# Local Modules (directly in context-store now)
# ---------------------------------------------------------------------------
# These are imported as individual modules since directory name has hyphens

try:
    import auto_compact
    import tool_result_storage
...
def get_project_root() -> Path:
    ...
    # Derive from this file's location - context_store is 3 levels deep in packages/
