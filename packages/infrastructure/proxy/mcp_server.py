...
try:
    ...
    from .api_key_pool import api_key_pool
    from .vpn_ip_pool import vpn_ip_pool
    from .router_brain import router_brain, MODEL_CAPABILITIES
    from .cost_optimizer import cost_tracker
    from .learning_engine import learning_engine
    _router_available = True
except Exception as e:
    logging.getLogger(__name__).warning(f"Intelligent Router components unavailable: {e}")
