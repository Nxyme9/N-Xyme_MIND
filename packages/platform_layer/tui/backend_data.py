...
def get_memory_stats():
    ...
    try:
        from packages.memory_core.mcp_server import get_memory_stats as _get_stats
        return _get_stats()
    except Exception:
...
def get_indexed_count():
    ...
    try:
        from packages.memory_core.indexing.embedder import get_indexed_count as _get_count
        return _get_count()
    except Exception:
...
def get_orchestration_status():
    ...
    try:
        ...
        return {"agents": len(registry.get_all_agents()), "agents_list": list(registry.get_all_agents().keys())}
    except Exception:
...
def get_learning_stats():
    ...
    try:
        from packages.memory_core.mcp_server import get_learning_stats as _get_stats
        return _get_stats()
    except Exception:
