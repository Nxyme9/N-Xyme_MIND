...
- **Topology**: Replace linear chain with Networked Reasoning ([Protocol 137](../protocols/decision/137-graph-of-thoughts.md)).
...
>
> **Protocol**: See [Protocol 099](protocols/architecture/099-session-output-architecture.md).
