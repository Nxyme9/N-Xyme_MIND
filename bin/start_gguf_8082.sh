#!/bin/bash
# GGUF Server Pool - Port 8082 (Qwen 2.5 Coder 7B for coding tasks)
# Usage: ./start_gguf_8082.sh
...
GGUF_MODEL=$MODEL nohup .venv/bin/python packages/local_llm/gguf_mcp_server.py --port $PORT > /tmp/gguf_8082.log 2>&1 &
