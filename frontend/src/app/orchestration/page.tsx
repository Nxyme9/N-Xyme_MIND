...
const modelMap: Record<string, string> = {
    sisyphus: "openrouter/minimax-m2.5-free",
    hephaestus: "openrouter/openai/gpt-4o",
    oracle: "openrouter/anthropic/claude-3.5-sonnet",
    explore: "openrouter/openai/gpt-4o",
    librarian: "openrouter/anthropic/claude-3.5-sonnet",
    prometheus: "openrouter/openai/gpt-4o",
    momus: "openrouter/google/gemini-1.5-pro",
    atlas: "openrouter/openai/gpt-4o",
    metis: "openrouter/openai/gpt-4o",
  };
  ...
  return {
    ...
    maxRetries: 3,
    capacity: 10,
    model: modelMap[backendAgent.id] || "openrouter/openai/gpt-4o",
  };
};

const DEFAULT_AGENTS: AgentConfig[] = [
  { id: "hephaestus", name: "Hephaestus", role: "Implementation", enabled: true, color: "#22c55e", icon: <Code2 className="w-4 h-4" />, timeout: 300, maxRetries: 3, capacity: 10, model: "openrouter/openai/gpt-4o" },
  { id: "oracle", name: "Oracle", role: "Architecture Review", enabled: true, color: "#3b82f6", icon: <Eye className="w-4 h-4" />, timeout: 300, maxRetries: 3, capacity: 10, model: "openrouter/anthropic/claude-3.5-sonnet" },
  { id: "explore", name: "Explore", role: "Codebase Search", enabled: true, color: "#06b6d4", icon: <Search className="w-4 h-4" />, timeout: 300, maxRetries: 3, capacity: 10, model: "openrouter/openai/gpt-4o" },
  { id: "librarian", name: "Librarian", role: "External Research", enabled: true, color: "#84cc16", icon: <BookOpen className="w-4 h-4" />, timeout: 300, maxRetries: 3, capacity: 10, model: "openrouter/anthropic/claude-3.5-sonnet" },
  { id: "prometheus", name: "Prometheus", role: "Plan Builder", enabled: true, color: "#8b5cf6", icon: <Target className="w-4 h-4" />, timeout: 300, maxRetries: 3, capacity: 10, model: "openrouter/openai/gpt-4o" },
  { id: "momus", name: "Momus", role: "Adversarial Review", enabled: true, color: "#ef4444", icon: <Eye className="w-4 h-4" />, timeout: 300, maxRetries: 3, capacity: 10, model: "openrouter/google/gemini-1.5-pro" },
  { id: "atlas", name: "Atlas", role: "Plan Executor", enabled: true, color: "#f97316", icon: <Target className="w-4 h-4" />, timeout: 300, maxRetries: 3, capacity: 10, model: "openrouter/openai/gpt-4o" },
];
