...
uv venv "$ROOT/venvs/athena" --python python3
uv pip install -e "$ROOT/athena" --python "$ROOT/venvs/athena/bin/python"
uv pip install hindsight-api sentence-transformers --python "$ROOT/venvs/athena/bin/python"
